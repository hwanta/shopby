...
from pages.product import productList
import time
...
class Test(TestCase):
    ...
    def setUpClass(cls):
        ...
        productList.accessProductList() # 각 테스트 해야할 항목의 함수를 입력(페이지별 수정 필요)
        time.sleep(1)
    ...
    def test_002(self):
        productList.searchProductReset()

    def test_003(self):
        productList.productModify()
