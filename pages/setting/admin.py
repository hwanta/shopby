...
def searchWord():
    ...
    # 검색어 입력
    element.InputByXPath('//*[@id="searchForm"]/table/tbody/tr[1]/td[1]/div/div/input', '이병욱', '267')
...
def advancedSearch():
    # 소속부서 드롭박스 클릭
    try:
        select1 = Select(login.create_driver.driver.find_element(by=By.XPATH,
                                                                 value='//*[@id="searchForm"]/table/tbody/tr[3]/td/select[1]'))
        select1.select_by_value("274")
        time.sleep(1)
        print("TC " + '272' + " PASS")
    except Exception as e:
        print(e)
    ...
    try:
        select1 = Select(login.create_driver.driver.find_element(by=By.XPATH,
                                                                 value='//*[@id="searchForm"]/table/tbody/tr[3]/td/select[2]'))
        select1.select_by_value("165")
        time.sleep(1)
        print("TC " + '272' + " PASS")
    except Exception as e:
        print(e)
...
def searchButton():
    ...
    findword = login.create_driver.driver.find_element(By.XPATH, value='/html/body/div[1]/div[3]/div[2]/div[1]/'
                                                                       'div/div/div/div[2]/div/div/div[1]/div[2]/'
                                                                       'div[2]/div/div[1]/table/tbody/tr/td[2]/div').text
    time.sleep(1)
...
def clickRegistration():
    element.ClickByXPath('/html/body/div[1]/div[3]/div[2]/div[1]/div/div/div/div[1]/div/button', '279')
...
def permissionGroup():
    try:
        ...
        select.select_by_value(random.choice(['1822', '1823', '1824']))
        time.sleep(1)
        print("TC " + '284' + " PASS")
    except Exception as e:
        print(e)
...
def editOperator():
    ...
    # wkehdghk12클릭
    element.ClickByLINKTEXT('wkehdghk12', '290-1')
...
# 운영자 수정 > 목록(TC_304)
def operatorList():
    login.create_driver.driver.find_element(By.LINK_TEXT, value='wkehdghk12').click()
    time.sleep(2)
