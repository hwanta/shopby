...
#
#     # # 기본정보 > 통신판매업 신고번호
#     # telemarketingNumber = libs.create_driver.driver.find_element(by=By.XPATH,
#     #                                                             value= BI + 'tr[3]/td[2]/div/div/input')
#     # telemarketingNumber.clear()
#     # telemarketingNumber.send_keys('0101111' + str(randomNumI))
#
#     # # 기본정보 > 대표이메일
#     # representativeEmail1 = libs.create_driver.driver.find_element(by=By.XPATH,
...
#     #
#     # # 기본정보 > 업태
#     # businessConditions = libs.create_driver.driver.find_element(by=By.XPATH,
#     #                                                            value= BI + 'tr[5]/td[2]/div/div/input')
#     # businessConditions.clear()
#     # businessConditions.send_keys('업태 의류' + str(randomNumT))
#
#     # # 기본정보 > 사업장 주소
#     # libs.create_driver.driver.find_element(by=By.XPATH,
...
#     #
#     # WebDriverWait(libs.create_driver.driver, 10).until(EC.presence_of_element_located \
...
#
#     # # 가장 하단으로 스크롤
#     # libs.create_driver.driver.execute_script("window.scrollTo(0, document.body.scrollHeight)")
#     #
#     # # 개인정보 > 보호책임자 이름
#     # managerName = libs.create_driver.driver.find_element(by=By.XPATH,
...
#
#     # # 개인정보 > 보호책임자 전화번호
#     # managerNumber = libs.create_driver.driver.find_element(by=By.XPATH,
#     #                                                       value= MI + 'tr[1]/td[2]/div/div/input')
#     # managerNumber.clear()
#     # managerNumber.send_keys('0101111' + str(randomNumI))
#
#     # 개인정보 > 보호책임자 소속/직위
#     # managerInfo1 = libs.create_driver.driver.find_element(by=By.XPATH,
#     #                                                      value=MI + 'tr[2]/td/div[1]/div/input')
#     # managerInfo1.clear()
#     # managerInfo1.send_keys('소속' + str(randomNumT))
#     #
#     # managerInfo2 = libs.create_driver.driver.find_element(by=By.XPATH,
#     #                                                      value=MI + 'tr[2]/td/div[2]/div/input')
#     # managerInfo2.clear()
#     # managerInfo2.send_keys('직위' + str(randomNumT))
#     #
#     # # 개인정보 > 보호책임자 이메일
#     # managerEmail1 = libs.create_driver.driver.find_element(by=By.XPATH,
#     #                                                       value=MI + 'tr[3]/td/div/div[1]/div/input')
#     # managerEmail1.clear()
#     # managerEmail1.send_keys('byungwook.lee' + str(randomNumT))
#     #
#     # managerEmail2 = libs.create_driver.driver.find_element(by=By.XPATH,
...
#         save = libs.create_driver.driver.find_element(by=By.XPATH, value='/html/body/div/div[4]/div/div[2]/button')
#
#         # 자바스크립트로 클릭 실행
#         libs.create_driver.driver.execute_script("arguments[0].click();", save)
#
