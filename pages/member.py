...
def MemberListSearch():
    searchWord = login.create_driver.driver.find_element(by=By.XPATH,
                                                         value='//*[@id="searchForm"]/table/tbody/tr[2]/td/div/input')  # 검색어 입력 찾기
    searchWord.clear()
    searchWord.send_keys('bomee331')  # 회원리스트 아이디 검색어 입력
    search = login.create_driver.driver.find_element(by=By.XPATH,
                                                     value='//*[@id="searchForm"]/table/tbody/tr[1]/td[2]/div/button[1]')  # 검색 버튼 찾기
