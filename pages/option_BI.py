...
def inputBI() :
    ...
    # 기본정보 > 회사명
    companyName = login.driver.find_element(by=By.XPATH,
    ...
    # 개인정보 > 보호책임자 이름
    managerName = login.driver.find_element(by=By.XPATH,
    ...
    try :
        # [저장] 버튼 클릭
        save = login.driver.find_element(by=By.XPATH,
                                     value='/html/body/div/div[4]/div/div[2]/button')
        save.click()
        # alert 존재하면 내용 출력, 없으면 pass 출력
        WebDriverWait(login.driver, 3).until(EC.alert_is_present())
