...
def login() :
    ...
    try :
        ...
        create_driver.driver.find_element(by=By.XPATH, value='//*[@id="container"]/div[2]/div/form/div/table/tr[1]/td/input').send_keys('shopbyproadmin')  # xpath 사용
        create_driver.driver.find_element(by=By.CSS_SELECTOR, value='#container > div.content_login > div > form > div > table > tr:nth-child(2) > td > input').send_keys('WkaQhd@629') # css_selector 사용
