...
def mallEdit() :
    ...
    # 쇼핑몰명 변경
    mallName = lib.create_driver.driver.find_element(by=By.NAME,
                                                     value='mall.mallName')
    mallName.clear()
    ...
    # 고객센터 이메일
    email1 = lib.create_driver.driver.find_elements(by=By.NAME,
                                                    value='representative.email')[0]
    email1.clear()
    email1.send_keys('byungwook.lee')

    email2 = lib.create_driver.driver.find_elements(by=By.NAME,
